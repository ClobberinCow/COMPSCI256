...
extern const uint8_t image0_start[]   asm("_binary_src_image0_start");
extern const uint8_t image1_start[]   asm("_binary_src_image1_start");
extern const uint8_t image2_start[]   asm("_binary_src_image2_start");
extern const uint8_t image3_start[]   asm("_binary_src_image3_start");
extern const uint8_t image4_start[]   asm("_binary_src_image4_start");
extern const uint8_t image5_start[]   asm("_binary_src_image5_start");
extern const uint8_t image6_start[]   asm("_binary_src_image6_start");
extern const uint8_t image7_start[]   asm("_binary_src_image7_start");
extern const uint8_t image8_start[]   asm("_binary_src_image8_start");
extern const uint8_t image9_start[]   asm("_binary_src_image9_start");
...
int inference_cli_handler_1(int pic)
{
    /* Just to go to the next line */
    printf("\n");
    int image_number = pic;
...
int esp_cli_register_cmds()
{
    ...
    for (i = 0; i < cmds_num; i++) {
        ESP_LOGE(TAG, "Registering command: %s", diag_cmds[i].command);
